...
class _StudentPageState extends State<StudentPage> {
  ...
  void addStudent() async {
    ...
    final student = Student(
      ...
      quiz: double.tryParse(quizController.text.trim()) ?? 0.0,
      activity: double.tryParse(activityController.text.trim()) ?? 0.0,
      exam: double.tryParse(examController.toString().trim()) ?? 0.0,
    );
